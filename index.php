        ...
        <div class="site-wrapper-inner">
            ...
            <div class="cover-container">
                ...
                <div class="masthead clearfix">
                    <div class="inner">
                    <a ui-sref="main"><h3 class="masthead-brand">AngularJS's Sample Page</h3></a>
                ...
                <div class="inner cover">
                    ...
                    <!-- UI_VIEW_PLACEHOLDER -->
                    <div ui-view="">
                    <h1>Welcome to my Sample website!</h1><p>In this website you will find information about me and my projects</p>
                    </div>
                ...
                <div class="mastfoot">
                    <div class="inner">
                        <p>Cover template for
                            ...
                            <a href="https://www.facebook.com/tharmarajan.natarajan/">@Tharmaraj N</a>.
                        </p>
                    </div>
                </div>
